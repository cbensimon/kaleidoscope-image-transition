...
var Curves, DragDrop, Kaleidoscope, Timer, c, dragger, gui, i, image, kaleidoscope, len, onChange, onMouseMoved, options, ref, tr, tx, ty, update,
...
Curves = (function() {
  function Curves(values, timer) {
    this.xBegin = values.x.begin;
    this.xEnd = values.x.end;
    this.yBegin = values.y.begin;
    this.yEnd = values.y.end;
    this.timer = timer;
  }
  ...
  Curves.prototype.x = function() {
    var t;
    t = this.timer.getT();
    return linear(this.xBegin, this.xEnd, t);
  };

  Curves.prototype.y = function() {
    var t;
    t = this.timer.getT();
    return linear(this.yBegin, this.yEnd, t);
  };

  Curves.prototype.linear = function(begin, end, t) {
...
onMouseMoved = (function(_this) {
  return function(event) {
    ...
    return ty = hy * kaleidoscope.radius * 2;
  };
})(this);
